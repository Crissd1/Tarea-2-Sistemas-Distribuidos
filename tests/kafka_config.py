"""
Configuración centralizada para la integración de Apache Kafka.

Este módulo define los nombres de tópicos, grupo de consumidores,
servidor Kafka y parámetros generales que serán utilizados por
producer, consumers, sistema de reintentos y DLQ.
"""
...
# Servidor Kafka.
# En ejecución local desde la VM: localhost:9092.
# Si luego se ejecuta todo dentro de Docker, este valor puede cambiar a kafka:9092.
KAFKA_BOOTSTRAP_SERVERS = os.getenv("KAFKA_BOOTSTRAP_SERVERS", "localhost:9092")


# Tópicos principales del sistema.
...
# Todos los consumidores principales deben usar el mismo grupo
# para que Kafka distribuya automáticamente las consultas.
